...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.datatables.net/v/bs4/dt-1.10.20/datatables.min.css"
        integrity="sha384-J/JrQzMo5A/ewqt8Xsq6nTHQVVAk/OOhH66uqpFN9+3+MiM427Ub97OApi7o6orj" crossorigin="anonymous" />
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('admin/media*')) ? 'active' : '' }}"
                            href="{{ route('media.index') }}">Videos</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('admin/contact*')) ? 'active' : '' }}"
                            href="{{ route('contact.index') }}">Customer Service</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ (request()->is('admin/guest*')) ? 'active' : '' }}"
                            href="{{ route('guest.index') }}">Guests</a>
                    </li>
                    <li class="nav-item">
    ...
    <script src="https://cdn.datatables.net/v/bs4/dt-1.10.20/datatables.min.js"
        integrity="sha384-hVry8+iweLeSXncfkJ1oB4r2dRAI2pHZNsSCjTJl4o6hspfUDuGlBKm1nqORIp3S" crossorigin="anonymous">
    </script>
